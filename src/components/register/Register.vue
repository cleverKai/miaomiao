<template>
    <div class="register_body">
        ...
        <div class="register_link">
            <router-link to="/mine/login">已有账号立即注册</router-link>
...
<style scoped lang="css">
    ...
    .register_body .register_email button {position: absolute; top: 10px; right: 10px; height: 30px; border-radius: 3px; border:none;
        padding: 5px;}
